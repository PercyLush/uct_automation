...
faculty_path = 'C:\\Users\\Bheki Lushaba\\uct_automation\\Requirements\\LawRequirements.json'
    ...
    with open(faculty_path, 'r') as file1, open(references, 'r', encoding='utf-8') as ref:
        ...
        for item in data:
            for Reference in REF:
                ...
                if item['InstitutionID'] == Reference['InstitutionID'] and Reference["Name"] == "Law" :#Faculty Name
